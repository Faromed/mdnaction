...
$pagination_data = get_all_paginated($pdo, 'projets', $items_per_page, $current_page, 'date_creation');

$projets = $pagination_data['items'];
$total_projets = $pagination_data['total_items'];
