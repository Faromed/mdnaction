...
$pagination_data = get_all_paginated($pdo, 'blog', $items_per_page, $current_page, 'date_publication');

$blog_posts = $pagination_data['items'];
$total_blog_posts = $pagination_data['total_items'];
